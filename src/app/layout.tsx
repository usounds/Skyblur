    ...
    <html lang="ja">
      ...
      >
        ...
        <footer className="flex gap-6 flex-wrap items-center justify-center text-gray-600 bg-white py-4 mt-10">
          ...
          <a href="https://github.com/usounds/Skyblur" target="_blank" className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
