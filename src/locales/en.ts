const messages = {
    ...
    CreatePost_PasswordDescription: "A password is required to view the unblurred text and additional.",
    CreatePost_PasswordRadio: "Use a password",
    CreatePost_PasswordInputDescription: "If you forget the password, you will no longer be able to view raw test or edit it. You cannot change this category after posting.",
