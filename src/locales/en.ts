export default {
    ...
    Home_Landing001Descrtption: "Always post from Skyblur. Enclose the parts you want to blur with [secret]. When posted from Skyblur, it will automatically be posted to Bluesky.",
    Home_Landing002Title: "Bluesky displays as ****",
    Home_Landing002Descrtption: "On Bluesky, the parts enclosed with [] will be blurred. Tap the embed to read the unblurred on Skyblur.",
    Home_Landing003Title: "Skyblur shows the unblurred text",
    Home_Landing003Descrtption: "The unblurred text will be displayed un Skyblur. If you want to delete a post, do it from Skyblur.",
