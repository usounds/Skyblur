const messages = {
    ...
    Home_Landing001Descrtption: "伏せたい投稿はSkyblurから。伏せたいところを[秘密だよ]でくくります。Skyblurから投稿すると、Blueskyに自動で投稿されます",
    ...
    CreatePost_Next: "次へ",
    CreatePost_PreviewStep: "プレビュー",
    CreatePost_SimplewithBranket: "シンプルモードでは[]を使えません",
