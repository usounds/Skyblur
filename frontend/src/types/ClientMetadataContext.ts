...
export const clientMetadataByEnv: ClientMetadataByEnv = {
    ...
    preview: {
        client_id: "https://skyblur-worker-preview.usounds.workers.dev/api/client-metadata.json",
        client_name: "Skyblur Preview",
        client_uri: "https://skyblur-worker-preview.usounds.workers.dev",
        logo_uri: "https://skyblur-worker-preview.usounds.workers.dev/favicon.ico",
        tos_uri: "https://skyblur-worker-preview.usounds.workers.dev/termofuse",
        policy_uri: "https://skyblur-worker-preview.usounds.workers.dev/termofuse",
        redirect_uris: ["https://skyblur-worker-preview.usounds.workers.dev/"],
        scope: "atproto transition:generic",
        grant_types: ["authorization_code", "refresh_token"],
        response_types: ["code"],
        token_endpoint_auth_method: "none",
