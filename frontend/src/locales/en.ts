const messages = {
    ...
    Login_Rejected: "Authentication was cancelled",
    ...
    CreatePost_PublishMethodTitle: "Publish Method Settings",
    CreatePost_VisibilityPublic: "Public",
    CreatePost_VisibilityPublicDescription: "Even with this setting, it will not be crawled by search engines or AI.",
    CreatePost_VisibilityLogin: "Login Required",
    ...
    CreatePost_VisibilityPassword: "Password Required",
    ...
    CreatePost_PublishMethodDescription: "Set the conditions for viewing the unblurred text and additional.",
