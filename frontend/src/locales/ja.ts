const messages = {
    ...
    CreatePost_PasswordTitle: "パスワード",
    CreatePost_PasswordDescription: "伏せた文字と補足を参照するのにパスワードを要求します。投稿した後はこの区分を変更できません。",
    CreatePost_PasswordRadio: "パスワードを使用する",
    CreatePost_PasswordInputDescription: "パスワードを忘れるとオリジナルの文章は参照できず、かつ、編集できなくなります。",
