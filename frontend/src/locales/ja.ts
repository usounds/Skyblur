const messages = {
    ...
    CreatePost_PublishMethodTitle: "公開方法設定",
    CreatePost_VisibilityPublic: "全体公開",
    CreatePost_VisibilityPublicDescription: "この設定にしても、検索エンジンやAIにクロールされることはありません",
    CreatePost_VisibilityLogin: "ログイン必須",
    ...
    CreatePost_VisibilityPassword: "パスワード必須",
