...
/* istanbul ignore next -- Icon default sizing is a static rendering fallback, not an E2E behavior branch. */
export const BuyMeACoffeeIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
        ...
        {...props}
    >
        <path d="M20.216 6.415l-.132-.666c-.119-.598-.388-1.157-.8-1.61A3.99 3.99 0 0 0 16.32 3H4.07a1 1 0 0 0-.99.858L1.07 17.858A4.004 4.004 0 0 0 5.02 22h10.98a4.004 4.004 0 0 0 3.95-3.142l.865-4.327a3.995 3.995 0 0 0 3.185-3.916v-.284a3.99 3.99 0 0 0-.804-2.482 3.98 3.98 0 0 0-2.98-1.434zm-4.007 11.205a2 2 0 0 1-1.973 1.38H5.02a2 2 0 0 1-1.975-2.071L4.838 5h11.482l-1.933 9.664a1 1 0 0 0 .98 1.196h2.822l-.196.76z" />
    </svg>
);
