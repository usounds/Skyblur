/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 439bef936f28372f4dacc8a6a8e6ba4e)
// Runtime types generated with workerd@1.20250813.0 2025-08-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SKYBLUR_OAUTH: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "JWT_SECRET" | "APP_VIEW_URL">> {}
}
